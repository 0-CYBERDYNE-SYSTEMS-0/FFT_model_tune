#!/usr/bin/env python3
"""
Clean Trinity Agricultural Fine-tuning Script
Fixed tokenization and proper data handling
"""
...
def main():
    ...
    print("🌱 Trinity 6B Agricultural Fine-tuning - Clean Version")
    print("=" * 58)
    ...
    try:
        ...
        # Train the model
        trainer = train_model(model, tokenizer, prepared_dataset)
